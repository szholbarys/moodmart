...
const promos: Promo[] = [
  ...
  },
  {
    ...
    ctaText:
      'Получите бесплатную косметичку Clinique при покупке любых двух средств ухода за кожей!',
  ...
  },
  {
    ...
    ctaText:
      'Ознакомьтесь с новой коллекцией макияжа от Chanel и подчеркните свою красоту!',
    image: '/images/promo1.svg',
    time: 604800,
  },
  {
    ...
    ctaText:
      'При покупке туши для ресниц Maybelline - подарок карандаш для глаз в подарок!',
    image: '/images/promo2.svg',
    time: 172800,
  },
  {
    ...
    ctaText:
      'Только сегодня и только для вас - скидка 50% на весь ассортимент косметики MAC!',
    image: '/images/promo1.svg',
    time: 432000,
  },
]
