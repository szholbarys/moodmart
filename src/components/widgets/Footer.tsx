    ...
    <div className="bg-black py-10 px-20">
      <div className="flex gap-[67px]">
        ...
        <div className="text-18px text-grey flex items-start">
          ...
          <button className="ml-4 text-grey border border-grey px-3 py-3.5 hover:text-white hover:border-current transition duration-200 ease-in-out">
            подписаться
          </button>
        </div>
      </div>
      ...
      <div className="mt-12 text-16px font-regular text-grey flex justify-center">
        2024 © MoodMart
      </div>
    </div>
  )
